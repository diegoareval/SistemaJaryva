...
//lista que contendra todos los registros de todos los bancos
        ...
        try {
            ...
            Query query = session.createQuery("From Salones");
    ...
    public List<Salones> listAllParameter(String parameter) {
       //atributo que contendra los registros encontrados
        ...
        try {
           ...
           //query que permite encontrar los registros por medio de una busqueda
            Query query = session.createQuery("From Salones where descripcion like '%"+parameter+"%' or idsalon like '%"+parameter+"%'");
            listado =(List<Salones>) query.list();
