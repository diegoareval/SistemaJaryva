...
public class ProgramacionesDao extends DaoGeneral{
     //Establecer conexion con la base de datos
    SessionFactory factory = HibernateUtil.getSessionFactory();
    Session session = null;
    
     public List<Programaciones> listAll() {
       
//lista que contendra todos los registros de todos los cargos
        List<Programaciones> listado = null;
        ...
        try {
            ...
            Query query = session.createQuery("From Programaciones");
            //permite llenar la lista de todos los bancos
            listado =(List<Programaciones>) query.list();
      ...
      public List<Programaciones> Buscar(int cod) {
       //atributo que contendra los registros encontrados
        ...
        try {
           ...
           //query que permite encontrar los registros por medio de una busqueda
            Query query = session.createQuery("From Programaciones where idprogramaciones like '%"+cod+"%' or capitan like '%"+cod+"%'");
            listado =(List<Programaciones>) query.list();
