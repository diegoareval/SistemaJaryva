 ...
 * @author DiegoArevalo
 */
public class AutorizacionDao extends DaoGeneral{
...
//lista que contendra todos los registros de todos los bancos
        List<Autorizacion> listado = null;
        ...
        try {
            ...
            Query query = session.createQuery("From Autorizacion");
            //permite llenar la lista de todos los bancos
            listado =(List<Autorizacion>) query.list();
    ...
    public List<Autorizacion> listAllParameter(String parameter) {
       //atributo que contendra los registros encontrados
        ...
        try {
           ...
           //query que permite encontrar los registros por medio de una busqueda
            Query query = session.createQuery("From Autorizacion where descripcion like '%"+parameter+"%' or idautorizacion like '%"+parameter+"%'");
            listado =(List<Autorizacion>) query.list();
