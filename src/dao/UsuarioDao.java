       ...
       //atributo que contendra los registros encontrados
        ...
        try {
           ...
           //query que permite encontrar los registros por medio de una busqueda
            Query query = session.createQuery("From Usuarios where nombre like '%"+parameter+"%' or codigo like '%"+parameter+"%' or usuario like '%"+parameter+"%'or nivel_acceso like '%"+parameter+"%'");
            listado =(List<Usuarios>) query.list();
